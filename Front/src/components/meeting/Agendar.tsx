...
export default function Agendar() {
    const [myMot, setMyMot] = useState("dar en adopcion");
                                ...
                                <div className="">
                                    ...
                                    <div className="flex flex-row justify-center items-center">
                                        <select
                                            ...
                                            onChange={e => {
                                                setMyMot(e.target.value); // Actualiza el estado local
                                                setValue('motivo', e.target.value); // Asegúrate de actualizar el valor en el formulario
                                            }}
